...
def test_integrity_error_path_returns_mukerrer(db_session):
    ...
    regenerate_qr_secret(u); db_session.commit()
    ...
    r1 = process_checkin(db_session, generate_token(u.id, u.qr_secret))
    r2 = process_checkin(db_session, generate_token(u.id, u.qr_secret))
